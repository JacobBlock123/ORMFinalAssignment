    ...
    public class ChoresController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Chores != null ? 
                          ...
                          Problem("Entity set 'ChoreContext.Chores'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,UserId,Type,DueDate,Complete")] Chore chore)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description,UserId,Type,DueDate,Complete")] Chore chore)
        {
            if (id != chore.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ChoreContext.Chores'  is null.");
            }
            var chore = await _context.Chores.FindAsync(id);
            if (chore != null)
            {
